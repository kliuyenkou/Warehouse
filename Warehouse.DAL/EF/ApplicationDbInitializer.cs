...
namespace Warehouse.DAL.EF
{
    public class ApplicationDbInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        ...
        {
            var shop1 = new Shop() { Title = "Nike shop. Minsk", Address = "pr-t Pobediteley, 65, Minsk", Schedule = "Sun.-Mon.: 9 - 21" };
            var shop2 = new Shop() { Title = "Nike store. London", Address = "14-16 Neal Street, London", Schedule = "Sun.-Mon.: 10 - 20" };
            var shop3 = new Shop() { Title = "Nike Town", Address = "6 E 57th St, New York", Schedule = "Sun.-Mon.: 10 - 20" };
